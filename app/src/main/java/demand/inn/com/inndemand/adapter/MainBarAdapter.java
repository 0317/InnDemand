 ...
 * Created by akash
 */
public class MainBarAdapter extends  RecyclerView.Adapter<MainBarAdapter.MyViewHolder>  {
    ...
    public MainBarAdapter(Context mContext, List<MaincourseData> cartData) {
        this.mContext = mContext;
        this.cartData = cartData;
    }

    @Override
    public MainBarAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
